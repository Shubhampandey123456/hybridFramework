...
public class ExtentLogUtilities {
	public static void pass(WebDriver Driver, ExtentTest test, String msg, Logger log) throws IOException {
		...
		log.debug(msg);
		String path=new ScreenShot(Driver, System.getProperty("user.dir") + "/ScreenShotsResult/pass/").saveScreenShots();
	...
	public static void fail(WebDriver Driver, ExtentTest test, String msg, Logger log) throws IOException {
		...
		log.error(msg);
		String path=new ScreenShot(Driver, System.getProperty("user.dir") + "/ScreenShotsResult/fail/").saveScreenShots();
